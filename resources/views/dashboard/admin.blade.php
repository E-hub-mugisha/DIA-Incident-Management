    ...
    <div class="page-inner">
        <div class="row">
            <div class="col-md-12">
                ...
                {{-- Export Buttons --}}
                <div class="mb-4">
                    <a href="{{ route('dashboard.export.excel') }}" class="btn btn-sm" style="background: #002511; color:#f8f9fa;">Export Excel</a>
                    <a href="{{ route('dashboard.export.pdf') }}" class="btn btn-sm" style="background: #002511; color:#f8f9fa;">Export PDF</a>
                </div>
            </div>
        </div>
        {{-- Summary Cards --}}
        <div class="row mb-4">
            <div class="col-md-3">
                <div class="card text-white mb-3" style="background: #002511;">
                    <div class="card-body">
                        <h5 class="card-title" style="color: #f8f9fa;">Total Users</h5>
            ...
            <div class="col-md-3">
                <div class="card text-white mb-3" style="background: #002511;">
                    <div class="card-body">
                        <h5 class="card-title" style="color: #f8f9fa;">Total incidents</h5>
            ...
            <div class="col-md-3">
                <div class="card text-white mb-3" style="background: #002511;">
                    <div class="card-body">
                        <h5 class="card-title" style="color: #f8f9fa;">Total Mitigations</h5>
            ...
            <div class="col-md-3">
                <div class="card text-white mb-3" style="background: #002511;">
                    <div class="card-body">
                        <h5 class="card-title" style="color: #f8f9fa;">Departments</h5>
